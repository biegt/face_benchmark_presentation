...
## <div style="width: 80%; margin-left: 20%;"> `r rmarkdown::metadata$title` </div>
...
* Insbesondere <mark class="turquoise">Studien zu demographischen Biases in kommerziellen Services</mark> sind rar (erstaunlich, weil Face-Based Gender Inference große öffentliche Aufmerksamkeit erhalten hat `r Cite(bibliography, c("buolamwini2018gender", "raji2019actionable"))`
]
