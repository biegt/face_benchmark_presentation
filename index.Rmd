...
<p style = "color: #4cbfac; line-height: 200%; size: 12;"> Theoretischer Hintergrund <br>
Forschungsfragen <br>
...
----
---
## `r fontawesome::fa("book", fill = "#c5ebd5")` Theoretischer Hintergrund - Modelle zur Analyse menschlicher Gesichter
----
.pull-left[
* Technischer Fortschritt führt zu immer breiterer Anwendung von computergestützten <mark class="turquoise">Modellen, die menschliche Gesichter in Bildern und Videos analysieren </mark> ("Automated Facial Analysis") `r Cite(bibliography, c("lynch2020face", "shepley2019deep", "norval2017public"))`

* <mark class="turquoise">Anwendungsbereiche</mark>: Strafverfolgung, Authentifizierung, etc.

* Unternehmen haben begonnen, diese Modelle als <mark class="turquoise">kommerzielle Services</mark> anzubieten `r Cite(bibliography, c("buolamwini2018gender", "amazon_2021_rekog", "face_2021_face", "microsoft_2021_face"))`

* Studien haben gezeigt, dass diese Modelle <mark class="turquoise"> demografische Biases</mark> aufweisen `r Cite(bibliography, c("buolamwini2018gender", "grother2019face", "wang2019racial"))` ➔ Potentielle Folgen: Falsche Einzelentscheidungen bis hin zu systematischer Diskriminierung
]

.pull-right[
<u>*wired.com/story/hidden-role-facial-recognition-tech-arrests </u> (7. März 2022)* <p>

![:scale 90%](img/wired_article.png)
]

---
## `r fontawesome::fa("book", fill = "#c5ebd5")` Theoretischer Hintergrund - Demografische Biases in Machine Learning 
----

* Demografische Dimensionen: z.B. <mark class="turquoise">Gender, Race, Age</mark>

* Fairness im Sinne von <mark class="turquoise">Classification Parity</mark>: Leistung eines Modells soll bezüglich Gruppen, die durch bestimmte "Protected Attributes" (z.B. Gender, Race, Age) definiert sind, gleich bzw. ähnlich sein `r Cite(bibliography,  c("corbett2018measure"))`

* <mark class="turquoise">Beispiel</mark>: Bei einem Modell zur Face Verification sollte die Fehlerrate bei African Females auf ähnlichem Niveau sein wie bei Caucasian Males

* <mark class="turquoise">Demografischer Bias</mark> liegt vor, wenn Kriterium der Classification Parity in Bezug auf demgroafische Dimensionen verletzt ist

* Fokus auf demografische Biases in kommerziellen Services wichtig, da es sich um <mark class="turquoise">"Black Boxes"</mark> handelt 
...
* <mark class="turquoise">Labelling von Age</mark> für alle 20,000 Bilder im Datensatz nach der Methode von Kärkkäinen und Joo `r Cite(bibliography, c("karkkainen2021fairface"))`

* <mark class="turquoise">Auswahl von Bildpaaren</mark>

  * Randomisiert unter Berücksichtigung von Cosine Similarities zwischen MobileNetV2-Embeddings `r Cite(bibliography, c("sandler2018mobilenetv2"))`
...
* Nach <mark class="turquoise">demografischen Gruppen</mark>:
...
* Verwendeter Datensatz: <mark class="turquoise">Racial Faces in the Wild (RFW) </mark> `r Cite(bibliography, "wang2019racial")` - vier Gruppen nach <mark class="turquoise">Race</mark> (African, Asian, Caucasian, Indian)
...
* Berücksichtigung von <mark class="turquoise">Gender</mark> (Female, Male), <mark class="turquoise">Race</mark> (Asian, African, Caucasian, Indian) und <mark class="turquoise">Age</mark> (0-9, 10-19, 20-29, 30-39, 40-49, 50-59, 60-69)

* Verwendeter Datensatz: <mark class="turquoise">Fairface</mark> `r Cite(bibliography, c("karkkainen2019fairface", "karkkainen2021fairface"))`: 108,000 Unconstrained Images mit Labels für Gender, Race und Age
...
* Nach <mark class="turquoise">demografischen Gruppen</mark>:
  ...
  * MAEs am niedrigsten bei älteren Menschen (Megvii) oder bei besonders jungen Altersgruppen (Amazon, Microsoft)
...
* <mark class="turquoise">Face Verification</mark>
  * Ergebnisse zu Age und Race decken sich überwiegend mit anderen Studien (z.B. `r Cite(bibliography, c("wang2019racial", "grother2019face", "el2016face"))`)
...
* Analyse von Detection Errors lag nicht im Fokus der Arbeit
...
```{r, echo=FALSE, results="asis"}
PrintBibliography(bibliography, start = 32, end = 33)
```
