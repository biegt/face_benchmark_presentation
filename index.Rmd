...
`made with R and xaringan -` [`r fontawesome::fa("github")` bit.ly/face-benchmark](https://bit.ly/face-benchmark) 
...
* Insbesondere <mark class="turquoise">Studien zu demographischen Biases in kommerziellen Services</mark> sind rar (umso erstaunlicher, weil Face-Based Gender Inference große öffentliche Aufmerksamkeit erhalten hat `r Cite(bibliography, c("buolamwini2018gender", "raji2019actionable"))`
...
* Berücksichtigung von <mark class="turquoise">Gender</mark> (female, male), <mark class="turquoise">Race</mark> (Asian, African, Caucasian, Indian) und <mark class="turquoise">Age</mark> (<30, 30-39, 40-49, 50+)</mark>
...
* Muster demographischer Biases heterogener zwischen Services
...
* <mark class="turquoise">Face Verification</mark>
  ...
  * Außmaß von Gruppenunterschieden tendeziell niedriger im Vergleich zu anderen Studien `r Cite(bibliography, c("grother2019face"))`
...
* Experiment 2: Ausgehend von Replikation nur Accuracy als Vergleichsgröße berücksichtigt
...
* Auch <mark class="turquoise">Unterschiede zwischen demografischen Gruppen bei Face-Based Age Inference</mark>, die u.a. auf Biases in den Trainingsdaten hinweisen
